...
public class TestSobelHorizontal {
    @Test
    void testSobelHorizontal() throws IOException {
        Transformer transformer = new SobelVertical();
        InputStream targetTestImage = TestSobelHorizontal.class.getResourceAsStream("/sunflower.jpg");
